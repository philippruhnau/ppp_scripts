function [results] = RMAOV2(X,alpha, names)
...
results.SS.within = SSS;
results.SS.Serror = SSSE;
% mean of squares
results.MS.A = MSA;
...
results.MS.subjects = MSS;
results.MS.Serror = MSSE;
% degrees of freedom
results.DF.total = dfTO;
results.DF.A = dfA;
results.DF.Aerror = dfEA;
results.DF.B = dfB;
results.DF.Berror = dfEB;
results.DF.AB = dfAB;
results.DF.ABerror = dfEAB;
results.DF.subjects = dfS;
results.DF.Serror = dfSE;

% F-values
results.F.A = F1;
results.F.B = F2;
results.F.AB = F3;
results.F.subjects = F4;
% p-values
results.p.A = P1;
results.p.B = P2;
results.p.AB = P3;
results.p.subjects = P4;
% dfs
