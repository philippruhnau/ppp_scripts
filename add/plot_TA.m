...
% plot_TA(data, samplingRate, cfg) function for time-amplitude plots
%
% mandatory input:
%
...
%
% cfg.baseline  - positive value of baseline start-window in ms [100]
...
% cfg.xtime     - timepoints for the x-axis [is computed from data, sR
%                 and cfg.baseline]
%
