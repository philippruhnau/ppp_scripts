function [results] = RMAOV33(X,alpha,names)
...
%      names - cell array of strings containing factor names default: {'IV1' 'IV2' IV3' ...}
%    Outputs:
...
if nargin < 3, names = {'IV1' 'IV2' 'IV3'}; end
...
fprintf([names{1} '                      %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSA,v1,MSA,F1,P1,ds1);
fprintf(['Error(' names{1} ')               %11.3f%10i%15.3f\n\n'],SSEA,v2,MSEA);
fprintf([names{2} '                      %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSB,v3,MSB,F2,P2,ds2);
fprintf(['Error(' names{2} ')               %11.3f%10i%15.3f\n\n'],SSEB,v4,MSEB);
fprintf([names{3} '                      %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSC,v5,MSC,F3,P3,ds3);
fprintf(['Error(' names{3} ')               %11.3f%10i%15.3f\n\n'],SSEC,v6,MSEC);
fprintf([names{1} ' x ' names{2} '                %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSAB,v7,MSAB,F4,P4,ds4);
fprintf(['Error(' names{1} ' x ' names{2} ')         %11.3f%10i%15.3f\n\n'],SSEAB,v8,MSEAB);
fprintf([names{1} ' x ' names{3} '                %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSAC,v9,MSAC,F5,P5,ds5);
fprintf(['Error(' names{1} ' x ' names{3} ')         %11.3f%10i%15.3f\n\n'],SSEAC,v10,MSEAC);
fprintf([names{2} ' x ' names{3} '                %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSBC,v11,MSBC,F6,P6,ds6);
fprintf(['Error(' names{2} ' x ' names{3} ')         %11.3f%10i%15.3f\n\n'],SSEBC,v12,MSEBC);
fprintf([names{1} ' x ' names{2} ' x ' names{3} '          %11.3f%10i%15.3f%14.3f%9.4f%9s\n'],SSABC,v13,MSABC,F7,P7,ds7);
fprintf(['Error(' names{1} ' x ' names{2} ' x ' names{3} ')   %11.3f%10i%15.3f\n'],SSEABC,v14,MSEABC);
fprintf('---------------------------------------------------------------------------------------------------\n');
...
% results struct output
% sum of squares
results.SS.total = SSTO;
results.SS.A = SSA;
results.SS.Aerror = SSEA;
results.SS.B = SSB;
results.SS.Berror = SSEB;
results.SS.C = SSC;
results.SS.Cerror = SSEC;
results.SS.AB = SSAB;
results.SS.ABerror = SSEAB;
results.SS.AC = SSAC;
results.SS.ACerror = SSEAC;
results.SS.BC = SSBC;
results.SS.BCerror = SSEBC;
results.SS.ABC = SSABC;
results.SS.ABCerror = SSEABC;
results.SS.subjects = SSS;
results.SS.SWin = SSWS;
% mean of squares
results.MS.A = MSA;
results.MS.Aerror = MSEA;
results.MS.B = MSB;
results.MS.Berror = MSEB;
results.MS.C = MSC;
results.MS.Cerror = MSEC;
results.MS.AB = MSAB;
results.MS.ABerror = MSEAB;
results.MS.AC = MSAC;
results.MS.ACerror = MSEAC;
results.MS.BC = MSBC;
results.MS.BCerror = MSEBC;
results.MS.ABC = MSABC;
results.MS.ABCerror = MSEABC;

% degrees of freedom
results.DF.total = v16;
results.DF.A = v1;
results.DF.Aerror = v2;
results.DF.B = v3;
results.DF.Berror = v4;
results.DF.C = v5;
results.DF.Cerror = v6;
results.DF.AB = v7;
results.DF.ABerror = v8;
results.DF.AC = v9;
results.DF.ACerror = v10;
results.DF.BC = v11;
results.DF.BCerror = v12;
results.DF.ABC = v13;
results.DF.ABCerror = v14;
results.DF.subjects = v15;
results.DF.within = vWS;
...
results.df.C = [v5 v6];
results.df.AB = [v7 v8];
results.df.AC = [v9 v10];
results.df.BC = [v11 v12];
results.df.ABC = [v13 v14];
