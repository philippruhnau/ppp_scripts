function [results] = RMAOV32(X,alpha)
...
results.SS.AB = SSAB;
results.SS.ABerror = SSEB;
results.SS.AC = SSAC;
results.SS.ACerror = SSEC;
results.SS.BC = SSBC;
results.SS.BCerror = SSEBC;
results.SS.ABC = SSABC;
results.SS.ABCerror = SSEBC;
results.SS.subjects = SSBS;
...
results.MS.AB = MSAB;
results.MS.ABerror = MSEB;
results.MS.AC = MSAC;
results.MS.ACerror = MSEC;
results.MS.BC = MSBC;
results.MS.BCerror = MSEBC;
results.MS.ABC = MSABC;
results.MS.ABCerror = MSEBC;

% degrees of freedom
results.DF.total = v12;
results.DF.A = v1;
results.DF.Aerror = v2;
results.DF.B = v3;
results.DF.AB = v4;
results.DF.Berror = v5;
results.DF.ABerror = results.DF.Berror;
results.DF.C = v6;
results.DF.AC = v7;
results.DF.Cerror = v8;
results.DF.ACerror = results.DF.Cerror;
results.DF.BC = v9;
results.DF.ABC = v10;
results.DF.BCerror = v11;
results.DF.ABCerror = results.DF.BCerror;
results.DF.subjects = vBS;
...
results.df.AB = [results.DF.AB results.DF.ABerror];
results.df.AC = [results.DF.AC results.DF.ACerror];
results.df.BC = [results.DF.BC results.DF.BCerror];
results.df.ABC = [results.DF.ABC results.DF.ABCerror];
